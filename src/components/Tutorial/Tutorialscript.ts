...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  // ── DrawSigil ────────────────────────────────────────────────────────────────
  {
    ...
    page: 'draw',
    speaker: 'harper',
    harperText: "Adjust the lettering. Make sure you resize as large as possible. Draw Mode will let you draw. Use Delete, Undo, Redo. Clear all will give you a blank canvas.",
    advanceOn: 'next',
    skippable: true,
    showOverlay: false,
  },
  ...
  },
  {
    ...
    page: 'style',
    speaker: 'bennet',
    bennetText: "Next, choose a location. For now, you'll place it on the map. As your clearance improves, you'll be able to deploy it directly into the world — street level.",
    advanceOn: 'next',
    skippable: true,
    showOverlay: false,
  },
  {
    ...
    page: 'style',
    speaker: 'harper',
    harperText: "Before you send it out, add your SigiLites — your teammates. People you trust to back you up. If you don't have any yet, don't worry. You can add them later!",
    advanceOn: 'next',
    skippable: true,
    showOverlay: false,
  },
  {
    ...
    page: 'style',
    speaker: 'bennet',
    bennetText: "Once your sigil is placed, it goes live. Other agents will find it. Some will agree with what you're pushing. Others won't.  You'll get familiar with that on the SigiMap.",
    advanceOn: 'action',
