...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    bennetText: "Start with the statement. Keep it precise. Direct. No filler, this isn't journaling. When you are done typing, click 'Next'",
    advanceOn: 'action',
  ...
  },
  {
    ...
    page: 'style',
    speaker: 'both',
    harperText: "On the map, that kind of pressure doesn't strengthen — it builds things up! Sigils can get Stronger and Stronger!",
  ...
  },
  {
    ...
    page: 'style',
    speaker: 'both',
    harperText: "So charge and place your Sigils carefully. Choose your teams, and back them.",
  ...
  },
  {
    ...
    bennetText: "And when you see a Sigil in the world… decide whether you're going to charge or destroy it.",
    advanceOn: 'next',
    skippable: true,
    showOverlay: false,
  },
