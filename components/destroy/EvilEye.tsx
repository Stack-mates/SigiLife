...
/**
 * EvilEye — the OGL-rendered eye that presides over the destroy ritual.
 * STATUS: implemented — ported from v1 (git show main:.../EvilEye.tsx),
 * adapted: "use client", named export, reduced-motion guard. The pupil
 * tracks externalMouse (fed by DestroyRitual for unified mouse+touch).
 * Cleanup (cancelAnimationFrame + lose-context) was already present.
 * Third-party-derived shader code — exempt from our lint rules (CONVENTIONS).
...
export function EvilEye({
  ...
  useEffect(() => {
    ...
    // Reduced-motion: don't spin up WebGL; DestroyRitual shows a static eye.
    if (
